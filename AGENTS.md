# AGENTS.md — Project Context for AI Scraping Platform

> **INHERITS FROM:** `~/.Codex/AGENTS.md` (Global Master Directives)
...
For the 27,753 actor own-stack implementation, Codex and Codex must work only in `haqeeqiazadee-ux/Scraper-app`.
